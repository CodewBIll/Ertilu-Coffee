      ...
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-12 px-4 pt-5 sm:px-6 sm:pt-8 lg:px-8">
        <section className="grid items-start gap-8 lg:grid-cols-[1fr_0.92fr] lg:gap-10">
          <FadeIn className="max-w-2xl text-center sm:text-left">
            <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-[#e4ad39]/35 bg-white/60 px-4 py-2 text-[0.72rem] font-semibold uppercase tracking-[0.28em] text-[#8c694c] shadow-[0_12px_28px_rgba(58,34,15,0.06)] backdrop-blur-md sm:mx-0">
            ...
            <Image
              ...
              alt="Logo Ertilu"
              className="mx-auto sm:ml-8 sm:mr-0"
              width={300}
              height={300}
              priority
            />
